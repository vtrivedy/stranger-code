"""Configuration, constants, and model creation for Stranger Code CLI."""
...
# ============================================================================
# STRANGER THINGS COLOR SCHEME
# ============================================================================
# Inspired by the iconic Stranger Things aesthetic:
# - Neon red (the title, Upside Down portals)
# - Deep void black (the Upside Down)
# - Electric blue (Eleven's powers)
# - Retro terminal green (80s computer aesthetic)
# - Dusty amber/orange (Hawkins, Indiana vibes)
# ============================================================================

COLORS = {
    # Primary: The iconic Stranger Things red
    "primary": "#e21b1b",
    # Dim: Dusty crimson for muted elements
    "dim": "#6b3a3a",
    # User messages: Clean white
    "user": "#ffffff",
    # Agent/Assistant: Neon red glow
    "agent": "#ff1f1f",
    # Thinking: Eleven's power blue
    "thinking": "#3d5afe",
    # Tool calls: Dusty crimson (on-brand, distinguishable)
    "tool": "#8b4a4a",
    # Tool accent: Brighter dusty crimson for highlights
    "tool_accent": "#a65d5d",
    # Warning: 80s orange
    "warning": "#ff6b35",
    # Error: Deep portal red
    "error": "#ff0000",
    # Success: Muted crimson (on-brand)
    "success": "#a65d5d",
    # Accent: Electric blue
    "accent": "#3d5afe",
    # Background hint: Void black
    "void": "#0a0a0a",
    # Christmas lights palette (Joyce's lights!)
    "christmas_red": "#ff0000",
    "christmas_green": "#00ff00",
    "christmas_blue": "#0066ff",
    "christmas_yellow": "#ffff00",
    "christmas_orange": "#ff6600",
    "christmas_purple": "#9932cc",
}

# Stranger Things themed messages
STRANGER_MESSAGES = {
    "loading": [
    ...
    "error": [
        ...
        "Vecna's curse is spreading...",
    ],
}

# ASCII art banner - Stranger Things style
STRANGER_CODE_ASCII = """
[bold #e21b1b]
███████ ████████ ██████   █████  ███    ██  ██████  ███████ ██████       ██████  ██████  ██████  ███████
██         ██    ██   ██ ██   ██ ████   ██ ██       ██      ██   ██     ██      ██    ██ ██   ██ ██
...
DEEP_AGENTS_ASCII = STRANGER_CODE_ASCII
